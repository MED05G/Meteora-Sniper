...
type ServerCryptoOps = {
    ...
    verify(key: ArrayBuffer, data: ArrayBuffer, sig: ArrayBuffer): Promise<boolean>;
};
 ...
 */
type TLSVerifyCallback = (certs: Array<Uint8Array>, ca: Array<Uint8Array>) => PromiseLike<CryptoError | undefined>;
type QUICConfig = {
    /**
...
export type { Opaque, Class, Callback, PromiseDeconstructed, Host, Hostname, Port, Address, RemoteInfo, ClientCryptoOps, ServerCryptoOps, QUICClientCrypto, QUICServerCrypto, ResolveHostname, TLSVerifyCallback, QUICConfig, QUICClientConfigInput, QUICServerConfigInput, ConnectionId, ConnectionIdString, ConnectionMetadata, StreamId, StreamReasonToCode, StreamCodeToReason, QUICStreamMap, };
