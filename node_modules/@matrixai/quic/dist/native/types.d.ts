...
interface ConfigConstructor {
    new (): Config;
    withBoringSslCtx(verifyPeer: boolean, verifyAllowFail: boolean, ca?: Uint8Array | undefined | null, key?: Array<Uint8Array> | undefined | null, cert?: Array<Uint8Array> | undefined | null, sigalgs?: string | undefined | null): Config;
}
...
interface ConnectionConstructor {
    connect(serverName: string | undefined | null, scid: Uint8Array, localHost: HostPort, remoteHost: HostPort, config: Config): Connection;
    accept(scid: Uint8Array, odcid: Uint8Array | undefined | null, localHost: HostPort, remoteHost: HostPort, config: Config): Connection;
}
interface Header {
    ty: Type;
    version: number;
...
declare enum CongestionControlAlgorithm {
    Reno = 0,
    CUBIC = 1,
    BBR = 2
}
declare enum Shutdown {
    Read = 0,
    Write = 1
}
declare enum Type {
 ...
 */
declare enum ConnectionErrorCode {
    NoError = 0,
    InternalError = 1,
    ConnectionRefused = 2,
    FlowControlError = 3,
...
export { CongestionControlAlgorithm, Shutdown, Type, ConnectionErrorCode, CryptoError, };
export type { QuicheTimeInstant, ConnectionError, Stats, HostPort as Host, SendInfo, RecvInfo, PathStats, StreamIter, HostIter, PathStatsIter, PathEvent, Config, ConfigConstructor, Connection, ConnectionConstructor, Header, HeaderConstructor, };
