...
function decodeStakeInstruction(instruction) {
    ...
    let parsed;
    const decoded = web3_js_1.StakeInstruction.decodeInstructionType(instruction);
    switch (decoded) {
        case "Initialize": {
            const decodedIx = web3_js_1.StakeInstruction.decodeInitialize(instruction);
            parsed = {
                name: "initialize",
                accounts: [
                    {
        ...
        case "Authorize": {
            const decodedIx = web3_js_1.StakeInstruction.decodeAuthorize(instruction);
            parsed = {
                name: "authorize",
                accounts: [
                    {
        ...
        case "AuthorizeWithSeed": {
            const decodedIx = web3_js_1.StakeInstruction.decodeAuthorizeWithSeed(instruction);
            parsed = {
        ...
        case "Deactivate": {
            const decodedIx = web3_js_1.StakeInstruction.decodeDeactivate(instruction);
            parsed = {
                name: "deactivate",
                accounts: [
                    {
        ...
        case "Delegate": {
            const decodedIx = web3_js_1.StakeInstruction.decodeDelegate(instruction);
            parsed = {
                name: "delegate",
                accounts: [
                    {
        ...
        case "Merge": {
            const decodedIx = web3_js_1.StakeInstruction.decodeMerge(instruction);
            parsed = {
                name: "merge",
                accounts: [
                    {
        ...
        case "Split": {
            const decodedIx = web3_js_1.StakeInstruction.decodeSplit(instruction);
            parsed = {
                name: "split",
                accounts: [
                    {
        ...
        case "Withdraw": {
            const decodedIx = web3_js_1.StakeInstruction.decodeWithdraw(instruction);
            parsed = {
                name: "withdraw",
                accounts: [
                    {
...
class SolanaParser {
    ...
    constructor(programInfos, parsers) {
        ...
        const standardParsers = [
            ...
            [web3_js_1.StakeProgram.programId.toBase58(), decodeStakeInstruction],
        ];
